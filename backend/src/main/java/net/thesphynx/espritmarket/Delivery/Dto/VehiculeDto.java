...
public class VehiculeDto {
    ...
    private String status;
        ...
        @NotNull(message = "vehiclePhoto is required")
        private MultipartFile vehiclePhoto;

        @NotNull(message = "registrationCardFront is required")
        private MultipartFile registrationCardFront;

        @NotNull(message = "registrationCardBack is required")
        private MultipartFile registrationCardBack;
}
